...
namespace SolucaoCapitulo2
{
    public partial class Form1 : Form
    {
        ...
        {
            if (txtNome.Text == String.Empty || txtAnoNascimento.Text == String.Empty ||
        ...
        {
            if (txtAnoUltimoAniversario.Text != String.Empty && Convert.ToInt32(txtAnoUltimoAniversario.Text)
